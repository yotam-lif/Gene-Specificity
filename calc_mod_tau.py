...
output_file_path = os.path.join(base_dir, 'Outputs', f'mod_{tau_name}_values.json')
...
plt.title(f'mod_{tau_name} Values')
plt.xlabel('Score')
plt.ylabel('Frequency')

# Save the plot
histogram_path = os.path.join(base_dir, 'Outputs', f'mod_{tau_name}_values_histogram.png')
